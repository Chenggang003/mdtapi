...
public class CustomerRegisterDeviceBackup {
    private String customerRegisterDeviceBackupSysId;
    ...
    public String getCustomerRegisterDeviceBackupSysId() {
        return customerRegisterDeviceBackupSysId;
    }

    public void setCustomerRegisterDeviceBackupSysId(String customerRegisterDeviceBackupSysId) {
        this.customerRegisterDeviceBackupSysId = customerRegisterDeviceBackupSysId == null ? null : customerRegisterDeviceBackupSysId.trim();
    }
