...
public class CustomerBackup {
    private String customerBackupSysId;
    ...
    public String getCustomerBackupSysId() {
        return customerBackupSysId;
    }

    public void setCustomerBackupSysId(String customerBackupSysId) {
        this.customerBackupSysId = customerBackupSysId == null ? null : customerBackupSysId.trim();
    }
